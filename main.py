...
parser.add_argument('--scaling', type=float, default=1.0, help='linear scaling factor for timings')
args = parser.parse_args()

build_reader.read(args.build, args.shorthand, args.supply, args.delay, args.scaling)
